...
package KimlikDogrulamaService;

public class KPSPublicLocator extends org.apache.axis.client.Service implements KimlikDogrulamaService.KPSPublic {
    ...
    public KimlikDogrulamaService.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public KimlikDogrulamaService.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            KimlikDogrulamaService.KPSPublicSoapStub _stub = new KimlikDogrulamaService.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (KimlikDogrulamaService.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                KimlikDogrulamaService.KPSPublicSoapStub _stub = new KimlikDogrulamaService.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
