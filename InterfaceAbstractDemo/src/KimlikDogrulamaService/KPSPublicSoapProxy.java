...
public class KPSPublicSoapProxy implements KimlikDogrulamaService.KPSPublicSoap {
  private String _endpoint = null;
  private KimlikDogrulamaService.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new KimlikDogrulamaService.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public KimlikDogrulamaService.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
